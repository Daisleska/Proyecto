...
function ver(cod){
    $.ajax({
    type: "POST",
    url : "../empleados/ver_empleados.php?inf=1",
    data: "cod="+cod,
     beforeSend: function(){
      $('#titulo').html('...');
    },
  ...
  $.ajax({
    ...
    type: "POST",
    url : "../empleados/ver_empleados.php?inf=2",
    data: "cod="+ cod,
     beforeSend: function(){
      $('#body').html('...');
    },
    ...
    $('#ver-historial').attr('href','../../Vistas/empleados/ver-historial-inventario.php?articulo='+cod);
