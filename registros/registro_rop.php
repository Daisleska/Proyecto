                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Recibo de otro Proveedor</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fecha_rop" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_rop" name="fecha_rop" placeholder="Ingrese la fecha" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-producto_rop" class=" form-control-label">Producto</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-producto_rop" name="producto_rop" placeholder="Ingrese el Producto" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-cantidad_rop" class=" form-control-label">Cantidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-cantidad_rop" name="cantidad_rop" placeholder="Ingrese la cantidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-paletas_rop" class=" form-control-label">Unidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-paletas_rop" name="paletas_rop" placeholder="Ingrese la unidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-sap_rop" class=" form-control-label">SAP</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-sap_rop" name="sap_rop" placeholder="Ingrese SAP" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-unidad2_rop" class=" form-control-label">Unidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-unidad2_rop" name="unidad2_rop" placeholder="Ingrese la unidad" class="form-control"><span class="help-block"></span></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-presentacion_rop" class=" form-control-label">Presentación </label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-presentacion_rop" name="presentacion_rop" placeholder="Ingrese la presentacion" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-proveedor_rop" class=" form-control-label">Proveedor</label></div>
                                    <div class="col-12 col-md-6"><input type="text" id="hf-proveedor_rop" name="proveedor_rop" placeholder="Ingrese el proveedor" class="form-control"><span class="help-block"></span></div>
                                    </div>
