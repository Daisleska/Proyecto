                  ...
                  <div class="page-title">
                    <h4>Registrar</h4>
                        ...
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="#">Inventario Diario</a></li>
                        </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Inventario Granel Almacen Serviform</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-material_igas" class=" form-control-label">Material</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-material_igas" name="material_igas" placeholder="Ingrese el material" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-texto_igas" class=" form-control-label">Texto Breve del Material </label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-texto_igas" name="texto_igas" placeholder="Ingrese el texto del material" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-ce_igas" class=" form-control-label">CE</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-ce_igas" name="ce_igas" placeholder="Ingrese CE" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-libre_u_igas" class=" form-control-label">Libre Utilización</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-libre_u_igas" name="libre_u_igas" placeholder="Ingrese libre utilización " class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-umb_igas" class=" form-control-label">UMB</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-umb_igas" name="umb_igas" placeholder="Ingrese la UMB" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fecha_igas" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_igas" name="fecha_igas" placeholder="Ingrese la fecha" class="form-control"><span class="help-block"></span></div>
                                    </div>
