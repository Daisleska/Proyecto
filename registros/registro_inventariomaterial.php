                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Inventario Serviform Material</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-material_ism" class=" form-control-label">Material</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-material_ism" name="material_ism" placeholder="Ingrese el material" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-texto_ism" class=" form-control-label">Texto Breve del Material </label></div>
                                    <div class="col-12 col-md-6"><input 40 type="text" id="hf-texto_ism" name="texto_ism" placeholder="Ingrese el texto del material" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-ce_ism" class=" form-control-label">CE</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-ce_ism" name="ce_ism" placeholder="Ingrese CE" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-cantidad_ism" class=" form-control-label">Cantidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-cantidad_ism" name="cantidad_ism" placeholder="Ingrese la cantidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-umb_ism" class=" form-control-label">UMB</label></div> 
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-umb_ism" name="umb_ism" placeholder="Ingrese la UMB" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fecha_ism" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_ism" name="fecha_ism" placeholder="Ingrese la fecha" class="form-control"><span class="help-block"></span></div>
                                    </div>
