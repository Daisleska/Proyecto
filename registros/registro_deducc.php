                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="registro_asig.php">Asignaciones</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Deducciones</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-seguro_s" class=" form-control-label">Seguro Social</label></div>
                                    <div class="col-12 col-md-4"><input maxlength="20" type="text" id="hf-seguro_s" name="seguro_s" placeholder="Ingrese el Seguro Social" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-regimen_p" class=" form-control-label">Regimen Prestacional de Empleo</label></div>
                                    <div class="col-12 col-md-4"><input maxlength="20" type="text" id="hf-regimen_p" name="regimen_p" placeholder="Ingrese el Regimen Prestacional de Empleo" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-faov" class=" form-control-label">F.A.O.V</label></div>
                                    <div class="col-12 col-md-4"><input maxlength="20" type="text" id="hf-faov" name="faov" placeholder="Ingrese el F.A.O.V" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-caja_a" class=" form-control-label">Retención Caja de Ahorro</label></div>
                                    <div class="col-12 col-md-4"><input maxlength="20" type="text" id="hf-caja_a" name="caja_a" placeholder="Ingrese la Retención Caja de Ahorro" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-prestamo_p" class=" form-control-label">Prestamo Personal</label></div>
                                    <div class="col-12 col-md-4"><input maxlength="20" type="text" id="hf-prestamo_p" name="prestamo_p" placeholder="Ingrese el Prestamo Personal" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-memoriales" class=" form-control-label">Memoriales La Victoria C.A</label></div>
                                    <div class="col-12 col-md-4"><input maxlength="20" type="text" id="hf-memoriales" name="memoriales" placeholder="Ingrese el Memoriales La Victoria C.A" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-clausula_b" class=" form-control-label">Descuento Clausula Bicicletas</label></div>
                                    <div class="col-12 col-md-4"><input maxlength="20" type="text" id="hf-clausula_b" name="clausula_b" placeholder="Ingrese el Descuento Clausula Bicicletas" class="form-control"></div>
                                    </div>
