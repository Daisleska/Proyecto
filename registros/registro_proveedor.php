       ...
       <div class="col-lg-10">
           ...
           <form action="" method="post" class="form-horizontal">
             ...
             <div class="row form-group">
                   ...
                   <div class="col-12 col-md-10"><input type="text" id="" name="" placeholder="0010001010" class="form-control"><span class="help-block">Por favor ingrese fecha</span></div>
          </div>
               ...
               <div class="row form-group">
                   ...
                   <div class="col-12 col-md-10"><input type="text" id="" name="" placeholder="#" class="form-control"><span class="help-block">por favor ingrese el codigo</span></div>
          </div>
                 ...
                 <div class="row form-group">
                   ...
                   <div class="col-12 col-md-10"><input type="text" id="" name="" placeholder="Ven Aragua #00002" class="form-control"><span class="help-block">Ingresar cantidad</span></div>
          </div> 

           <div class="row form-group">
                   <div class="col col-md-2"><label for="" class=" form-control-label"># Teléfono:</label></div>

                   <div class="col-12 col-md-10"><input type="text" id="" name="" placeholder="0212-0010010" class="form-control"><span class="help-block">Ingresar la cantidad</span></div>
          </div>
