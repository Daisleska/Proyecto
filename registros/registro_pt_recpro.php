                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Producto Terminado Recibido de Producción</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fecha_ptrp" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_ptrp" name="fecha_ptrp" placeholder="Ingrese la fecha de recibo" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-producto_ptrp" class=" form-control-label">Producto</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-producto_ptrp" name="producto_ptrp" placeholder="Ingrese el Producto" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-presentacion_ptrp" class=" form-control-label">Presentación </label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-presentacion_ptrp" name="presentacion_ptrp" placeholder="Ingrese la presentacion" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-cantidad_ptrp" class=" form-control-label">Cantidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-cantidad_ptrp" name="cantidad_ptrp" placeholder="Ingrese la cantidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-paletas_ptrp" class=" form-control-label">Paletas</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-paletas_ptrp" name="paletas_ptrp" placeholder="Ingrese la paleta" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-observacion_ptrp" class=" form-control-label">Observación</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="120" type="text" id="hf-observacion_ptrp" name="observacion_ptrp" placeholder="Ingrese la observacion" class="form-control"><span class="help-block"></span></div>
                                    </div>
