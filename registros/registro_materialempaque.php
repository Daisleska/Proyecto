                ...
                <div class="page-header float-right">
                    <div class="page-title">
                     <select class="form-control">
                            ...
                            <option><a href="">Despachado a produccion</a></option>
                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Material de Empaque  con más Movimiento Serviform</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-codigo_mems" class=" form-control-label">Codigo</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="30" type="text" id="hf-codigo_mems" name="codigo_mems" placeholder="Ingrese el codigo" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-materiales_mems" class=" form-control-label">Materiales</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="30" type="text" id="hf-materiales_mems" name="materiales_mems" placeholder="Ingrese el material" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-almacen_mems" class=" form-control-label">Almacen</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="30" type="text" id="hf-almacen_mems" name="almacen_mems" placeholder="Ingrese el almacen" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-cantidad_mems" class=" form-control-label">Cantidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="30" type="text" id="hf-cantidad_mems" name="cantidad_mems" placeholder="Ingrese la cantidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-unidad_mems" class=" form-control-label">Unidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="30" type="text" id="hf-unidad_mems" name="unidad_mems" placeholder="Ingrese la unidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fecha_mems" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_mems" name="fecha_mems" placeholder="Ingrese la fecha" class="form-control"><span class="help-block"></span></div>
                                    </div>
