...
<!-- fin de hora y fecha-------------------------------------------------- -->
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                      ...
                      <ol class="breadcrumb text-right">
                            <li class="active">Recibido de otro Proveedor</li>
                            <li><a href="registrar_materiaprima.php">Recibido de INICA</a></li>
                        </ol>
       ...
       <div class="col-lg-10">
              ...
              <strong><li><i class="fa fa-edit"></i>  REGISTRAR</strong> Materia Prima recibida de otro proveedor
              </div>
           ...
           <form action="" method="post" class="form-horizontal">
             ...
             <div class="row form-group">
                   ...
                   <div class="col-12 col-md-10"><input type="date" id="" name="" placeholder="00-00-0000" class="form-control"><span class="help-block">Por favor ingrese fecha</span></div>
          </div>



               <div class="row form-group">
                   <div class="col col-md-2"><label for="hf-email" class=" form-control-label">#Codigo</label></div>

                   <div class="col-12 col-md-10"><input type="email" id="hf-email" name="hf-email" placeholder="#" class="form-control"><span class="help-block">por favor ingrese el codigo</span></div>
          </div>

                 <div class="row form-group">
                      <div class="col col-md-2"><label for="hf-password" class=" form-control-label">Producto</label></div>
                          <div class="col-12 col-md-10"><input type="text" placeholder="Producto" class="form-control"><span class="help-block">Por favor ingrese el nombre del producto</span></div>
                 </div>

                 <div class="row form-group">
                   <div class="col col-md-2"><label class=" form-control-label">Cantidad</label></div>

                   <div class="col-12 col-md-10"><input type="email" id="hf-email" name="hf-email" placeholder="0000" class="form-control"><span class="help-block">Ingresar cantidad</span></div>
          </div> 

           <div class="row form-group">
                   <div class="col col-md-2"><label for="hf-email" class=" form-control-label">Unidad</label></div>

                   <div class="col-12 col-md-10"><input type="email" id="hf-email" name="hf-email" placeholder="ltrs / pzas / klg" class="form-control"><span class="help-block">Ingresar la cantidad</span></div>
          </div>
