                ...
                <div class="page-header float-right">
                    <div class="page-title">
                     <select class="form-control">
                        ...
                        <option class="active"><a href="">Despachado a produccion</a></option>
                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Despacho a Producción</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-2"><label for="hf-fecha_dp" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_dp" name="fecha_dp" placeholder="Ingrese la fecha de despacho" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-2"><label for="hf-producto_dp" class=" form-control-label">Producto</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-producto_dp" name="producto_dp" placeholder="Ingrese el Producto" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-2"><label for="hf-presentacion_dp" class=" form-control-label">Presentación </label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-presentacion_dp" name="presentacion_dp" placeholder="Ingrese la presentacion" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-2"><label for="hf-cantidad_dp" class=" form-control-label">Cantidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-cantidad_dp" name="cantidad_dp" placeholder="Ingrese la cantidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-2"><label for="hf-unidad_dp" class=" form-control-label">Unidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-unidad_dp" name="unidad_dp" placeholder="Ingrese la unidad" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-2"><label for="hf-observacion_dp" class=" form-control-label">Observación</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="120" type="text" id="hf-observacion_dp" name="observacion_dp" placeholder="Ingrese la observacion" class="form-control"></div>
                                    </div>
