...
<!-- fin de hora y fecha-------------------------------------------------- -->
       ...
       <div class="col-lg-10">
              ...
              <strong><li><i class="fa fa-edit"></i>  REGISTRAR</strong> Materia Prima recibida de INICA Cagua
              </div>
           ...
           <form action="" method="post" class="form-horizontal">
             ...
             <div class="row form-group">
               ...
               <div class="row form-group">
                   <div class="col col-md-2"><label for="" class=" form-control-label">#Codigo</label></div>

                   <div class="col-12 col-md-10"><input maxlength="30" type="text" id="" name="" placeholder="#" class="form-control"><span class="help-block">por favor ingrese el codigo</span></div>
          </div>

                 <div class="row form-group">
                      <div class="col col-md-2"><label for="" class=" form-control-label">Producto</label></div>
                          <div class="col-12 col-md-10"><input maxlength="30" type="text" placeholder="Producto" class="form-control"><span class="help-block">Por favor ingrese el nombre del producto</span></div>
                 </div>

                 <div class="row form-group">
                   <div class="col col-md-2"><label class=" form-control-label">Cantidad</label></div>

                   <div class="col-12 col-md-10"><input maxlength="10" type="text" id="" name="" placeholder="0000" class="form-control"><span class="help-block">Ingresar cantidad</span></div>
          </div> 

           <div class="row form-group">
                   <div class="col col-md-2"><label for="" class=" form-control-label">Unidad</label></div>

                   <div class="col-12 col-md-10"><input type="text" id="" name="" placeholder="ltrs / pzas / klg" class="form-control"><span class="help-block">Ingresar la Unidad</span></div>
          </div>
