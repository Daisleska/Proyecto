                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Producto Terminado  Disponible en el Almacen Serviform</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fecha_ptda" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_ptda" name="fecha_ptda" placeholder="Ingrese la fecha" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-producto_ptda" class=" form-control-label">Producto</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-producto_ptda" name="producto_ptda" placeholder="Ingrese el Producto" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-presentacion_ptda" class=" form-control-label">Presentación </label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-presentacion_ptda" name="presentacion_ptda" placeholder="Ingrese la presentacion" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-cantidad_ptda" class=" form-control-label">Cantidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-cantidad_ptda" name="cantidad_ptda" placeholder="Ingrese la cantidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-paletas_ptda" class=" form-control-label">Paletas</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-paletas_ptda" name="paletas_ptda" placeholder="Ingrese la paleta" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-observacion_ptda" class=" form-control-label">Observación</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="120" type="text" id="hf-observacion_ptda" name="observacion_ptda" placeholder="Ingrese la observacion" class="form-control"><span class="help-block"></span></div>
                                    </div>
