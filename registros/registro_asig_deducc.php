                      ...
                      <div class="card-header">
                           <strong>Registro de Asignaciones y Deducciones</strong> 
                                   ...
                                   <div class="card-body card-block">
                                    ...
                                    <div class="col-12 col-md-6"><input maxlength="120" type="text" id="hf-descrip_ad" name="descrip_ad" placeholder="Ingrese la descripción" class="form-control"><span class="help-block"></span></div>
                                    </div>
