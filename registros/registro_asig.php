                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="registro_deducc.php">Deducciones</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Asignaciones</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-bono_p" class=" form-control-label">Bono de Producción</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-bono_p" name="bono_p" placeholder="Ingrese el Bono de Producción" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-prima_p" class=" form-control-label">Prima de Producción</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-prima_p" name="prima_p" placeholder="Ingrese la Prima de Producción" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-sabado_p" class=" form-control-label">Sabado Promedio</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-sabado_p" name="sabado_p" placeholder="Ingrese el Sabado Promedio" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-descanso_s" class=" form-control-label">Descanso Semanal</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-descanso_s" name="descanso_s" placeholder="Ingrese el descanso semanal" class="form-control"></div>
                                    </div>

                

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-feriado" class=" form-control-label">Feriado</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-feriado" name="descanso_s" placeholder="Ingrese el Feriado" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-refrigerios" class=" form-control-label">Refrigerios</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-refrigerios" name="refrigerios" placeholder="Ingrese el Refrigerios" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-prima_a" class=" form-control-label">Prima de Antiguedad</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-prima_a" name="prima_a" placeholder="Ingrese la Prima de Antiguedad" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-prima_prof_tsu" class=" form-control-label">Prima Prof. TSU</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-prima_prof_tsu" name="prima_prof_tsu" placeholder="Ingrese la Prima Prof. TSU" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-prima_h" class=" form-control-label">Prima por Hijo</label></div>
                                    <div class="col-12 col-md-4"><input type="text" id="hf-prima_h" name="prima_h" placeholder="Ingrese la Prima por Hijo" class="form-control"></div>
                                    </div>
