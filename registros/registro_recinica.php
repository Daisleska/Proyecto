                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                           <strong>Registro de Recibo de Inica Cagua</strong> 
                                </div>
                                   <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fecha_ric" class=" form-control-label">Fecha</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fecha_ric" name="fecha_ric" placeholder="Ingrese la fecha" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-producto_ric" class=" form-control-label">Producto</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-producto_ric" name="producto_ric" placeholder="Ingrese el Producto" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-presentacion_ric" class=" form-control-label">Presentación </label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-presentacion_ric" name="presentacion_ric" placeholder="Ingrese la presentacion" class="form-control"><span class="help-block"></span></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-cantidad_ric" class=" form-control-label">Cantidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-cantidad_ric" name="cantidad_ric" placeholder="Ingrese la cantidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-paletas_ric" class=" form-control-label">Unidad</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="20" type="text" id="hf-paletas_ric" name="paletas_ric" placeholder="Ingrese la unidad" class="form-control"><span class="help-block"></span></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-observacion_ric" class=" form-control-label">Observación</label></div>
                                    <div class="col-12 col-md-6"><input maxlength="120" type="text" id="hf-observacion_ric" name="observacion_ric" placeholder="Ingrese la observacion" class="form-control"><span class="help-block"></span></div>
                                    </div>
