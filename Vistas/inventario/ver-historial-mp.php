<?php
  ...
  $sql="SELECT * FROM materia_prima WHERE id='$articulo'";
  ...
  $sql="SELECT * FROM historial_mp WHERE tiempo BETWEEN '$tiempo_inicio' AND '$tiempo_fin' AND id_materia_prima='$articulo'";  
...
?>
        ...
        <div class="table-responsive">
          ...
          <tbody>
            <?php
              ...
              $sql="SELECT * FROM historial_mp WHERE historial_mp.id_materia_prima='$articulo' AND historial_mp.tiempo BETWEEN '$tiempo_inicio' AND '$tiempo_fin' order by id desc ";
  ...
  <script src="../../bootstrap/js/bootstrap.min.js"></script>
    ...
    $('#anio').on('change',function(){
      ...
      window.location='ver-historial-mp.php?articulo=<?php echo $articulo ?>&a='+anio;
