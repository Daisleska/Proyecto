<?php
	...
	function verificar_inventario(){
		...
		$sql="SELECT * FROM articulos WHERE stock<=stock_minimo AND activo='S' AND borrado='N'";
	...
	function contador_inventario(){
		...
		$resultado= mysqli_query($conexion,"SELECT articulos.stock FROM articulos WHERE articulos.stock <articulos.stock_minimo AND borrado='N' AND activo='S'");
	    $res_busqueda=mysqli_num_rows($resultado);
