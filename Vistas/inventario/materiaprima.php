<?php
          ...
          if ($borrar=='') {
            # code...
              ...
              $sql="UPDATE materia_prima SET borrado='S' WHERE id='$borrar'";

              $resultado=mysqli_query($conectar,$sql);

              if ($resultado) {
                header('location: materiaprima.php?e=1');
              }else{
                header('location : materiaprima.php?e=2');
              }
              ...
              if ($ar=='') {
                ...
                if ($agregar=='') {
                  ...
                  if ($agregar<=0) {
                    ...
                    $sql="SELECT * FROM materia_prima where id='$ar'";
                    $resultado=mysqli_query($conectar,$sql);
                    $i=0;
                    ...
                    if ($i==0) {
                            echo '
                              ...
                              <script>
                                $(document).ready(function(){
                                  swal("Error","Materia prima no encontrado", "error");
                                });
                              </script>
                          ';  
                    }else{
                      ...
                      if ($i>1) {
                       header('location: materiaprima.php');
                        ...
                        $sql="UPDATE materia_prima SET stock='$nuevo_stock' where id='$ar'";

                        $resultado=mysqli_query($conectar,$sql);

                        if ($resultado) {

                            include('funciones/funcion-materiaprima.php');

                            $res=sumar_articulo($ar,$agregar,$_SESSION['id']);

                            header('location: materiaprima.php?act=1');
                      ...
                      if ($nuevo_stock<0) {
                        ...
                        $sql="UPDATE materia_prima SET stock='$nuevo_stock' where id='$ar'";
                          ...
                          if ($resultado) {
                                ...
                                restar_articulo($ar,$retirar,$_SESSION['id']);                       
                              header('location: materiaprima.php?act=1');
                          }else{
                              header('location: materiaprima.php?act=2');
  ...
  <div class="contenido" style="padding-left: 20px">
    ...
    <!--nav inventario -->
        ...
        <?php
          ...
          $resultado= mysqli_query($conectar,"SELECT materia_prima.stock FROM materia_prima WHERE materia_prima.stock <materia_prima.stock_minimo AND borrado='N' AND activo='S'");
          $i=0;
          while ($consulta = mysqli_fetch_array($resultado)) {
            $i++;
            break;
            ...
            <table class="table table-striped table-sm " id="table">
                <thead>
                  ...
                  include('../../Modelos/conexion.php');
                    ...
                    $sql="SELECT * FROM materia_prima  WHERE borrado='N'";
...
<!--   <script src="bootstrap/js/jquery.js"></script>
  ...
  <script src="../../bootstrap/js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript" src="../../vendors/js/materiaprima.js"></script> 
    <script>
      ...
      <?php
        ...
        if ($reg==1) {
            echo "
              iziToast.success({
                title: '¡Registrado! ',
                message: 'Materia prima registrado correctamente',
          ...
          echo
               "iziToast.error({
                ...
                message: 'La Materia Prima no pudo ser registrado',
                color: '#ffb6bb',
        ...
        if ($act==1) {
          ...
          echo
               "iziToast.error({
                ...
                message: 'La materia prima no pudo ser actualizado',
                color: '#ffb6bb',
        ...
        if ($e==1) {
            echo "
              iziToast.success({
                title: '¡Eliminado! ',
                message: 'Materia prima eliminado correctamente',
                color: 'rgb(174, 240, 191)',
          ...
          echo
               "iziToast.error({
                ...
                message: 'La materia prima no pudo ser eliminado',
                color: '#ffb6bb',
   ...
   if ($env==1) {
            echo "
              iziToast.success({
                title: '¡Enviado! ',
                message: 'Materia prima se ha enviado correctamente',
                color: 'rgb(174, 240, 191)',
          ...
          echo
               "iziToast.error({
                ...
                message: 'La materia prima no pudo ser enviado',
                color: '#ffb6bb',
