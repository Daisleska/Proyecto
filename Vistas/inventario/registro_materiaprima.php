      ...
      if ($stock<0 or $stock_minimo<0 or $stock_maximo<0 ) {
        ...
        '; 
            ...
            if ($stock>$stock_maximo) {
              ...
              $sql="SELECT * FROM materia_prima WHERE codigo='$codigo' AND borrado='N'";
              ...
              if ($res_busqueda>0) {
                ...
                error_reporting(0);
                    ...
                    $sql="INSERT INTO materia_prima(codigo,nombre,presentacion,unidad,stock, stock_minimo, stock_maximo,activo) VALUES ('$codigo','$nombre','$presentacion','$unidad','$stock','$stock_minimo', '$stock_maximo','$activo')"; 
...
/*$id_usuario=$_SESSION['id'];
   $sql="INSERT INTO art_almacen(id_articulo,id_ubicacion,stock,id_usuario) VALUES ('".$ar."','".$ubicacion."','".$stock."','".$id_usuario."')";

  $result=mysqli_query($conectar,$sql);*/
                  


                  header('location: materiaprima.php?reg=1');
                }else{
                 header('location: materiaprima.php?reg=2');
...
?>
 ...
 <form action="registro_materiaprima.php" method="POST" enctype="multipart/form-data">
  ...
  <script src="../../vendors/js/sweetalert.min.js"></script>
  <script  src="../../vendors/js/mp.js"></script>
    ...
    <script>
      ...
      function nuevos_campos(){
        ...
        $('#form').prop('action','registro_materiaprima?i='+cont);// URL para registrar
      }
