<?php
	...
	$sql="SELECT * FROM materia_prima WHERE id='$cod'";
	...
	while ($consulta=mysqli_fetch_array($resultado)) {
		if ($inf==1) {
			...
			<label><strong><h4>Detalles de la Materia prima:</h4></strong></label><br><br>
			<div class="row">
			<!-- 	<div class="col">
  ...
  echo "<img class=\"foto\" src=\""."img/".$consulta['foto']."\"/ width='40%' heigth='40%' >";
		...
		<div class="row">
				<div class="col-md-6">
					<label><strong>Codígo de la Materia prima:</strong></label>
