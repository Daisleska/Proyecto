...
<!-- fin de hora y fecha-------------------------------------------------- -->
        <div class="breadcrumbs col-md-12">
           ...
           <div class="page-header float-right col-md-8">
             <div class="row invoice-info col-sm-8">
        <div class="invoice-col">
        <form action="index.php?llave=guardar_asistencia" method="POST" id="asistencia">
          <div">
            <label>Cédula de Empleado:</label>
                <input type="number" maxlength="8" name="cedula" id="cedula" placeholder="Cédula" class="form-control" required>
                   
              <button type="submit" class="btn btn-success" id="submit_btn" data-loading-text="Buscando Persona....">Buscar <i class="fa fa-search"></i></button>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Listado de Nomina</strong>
                            </div>
                            <div class="card-body">
