       ...
       <div class="col-lg-10">
           ...
           <form action="../../Controladores/ControladorProveedor.php?operacion=guardar" method="post"  class="form">
             ...
             <div class="row form-group">
                   ...
                   <div class="col-12 col-md-10"><input type="text" id="" name="ci_pro" placeholder="0010001010" class="form-control"></div>
          </div>
               ...
               <div class="row form-group">
                   ...
                   <div class="col-12 col-md-10"><input type="text" id="" name="nombre_pro" placeholder="#" class="form-control"></div>
          </div>

                 <div class="row form-group">
                   <div class="col col-md-2"><label for="hf-email" class=" form-control-label">Correo:</label></div>

                   <div class="col-12 col-md-10"><input type="email" id="hf-email" name="email_pro" placeholder="#" class="form-control"></div>
               </div>
                 ...
                 <div class="row form-group">
                   ...
                   <div class="col-12 col-md-10"><input type="text" id="" name="direccion_pro" placeholder="Ven Aragua #00002" class="form-control"></div>
          </div> 

           <div class="row form-group">
                   <div class="col col-md-2"><label for="" class=" form-control-label"># Teléfono:</label></div>

                   <div class="col-12 col-md-10"><input type="text" id="" name="telefono_pro" placeholder="0212-0010010" class="form-control"></div>
          </div>
