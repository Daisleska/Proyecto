...
<head>
    <script type="text/javascript">
        function eliminar(id_ad) {
            if (confirm("Seguro que desea eliminar el registro?")) {
                    window.location="../../Controladores/ControladorAsigDeducc.php?operacion=eliminar&id="+id_ad;
            }
        }
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <td><a href="../../Controladores/ControladorAsigDeducc.php?operacion=modificar&id=<?=$data[$i][0]?>">Modificar</a>
