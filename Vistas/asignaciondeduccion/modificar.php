...
$conex=$db->conectar();
extract($_REQUEST);
$sql="SELECT * FROM asignacion_deduccion WHERE id=".$id_ad;
                      ...
                      <div class="card-header">
                           <strong>Registro de Asignaciones y Deducciones</strong> 
                                   ...
                                   <div class="card-body card-block">
                                    ...
                                    <div class="col-12 col-md-6"><input maxlength="120" type="text" id="hf-descrip_ad" name="descripcion_ad" placeholder="Ingrese la descripción" class="form-control" required="required" value="<?php echo $data['descripcion_ad']; ?>"><span class="help-block"></span></div>
                                    </div>
