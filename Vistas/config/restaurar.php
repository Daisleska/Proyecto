<?php include_once "../includes/menu.php"; ?>
    ...
    <section class="content-header">
      <h1>Herramientas<small>Restaurar BD</small></h1>
      <ol class="breadcrumb">
...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'servidata');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", '../../BD'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'servidata.sql'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
