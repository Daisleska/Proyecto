                      ...
                      <div class="card-header">
                           <strong>Modificar Empleado</strong> 
                                   ...
                                   <div class="card-body card-block">
                                    ...
                                    <div class="col col-md-4"><label for="hf-ci" class=" form-control-label">C.I:</label></div>
                                    <div class="col-12 col-md-5"><input type="number" id="hf-ci" name="cedula" placeholder="Ingrese el número de cedula" required="required" class="form-control" value="<?php echo $data['cedula']; ?>"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-4"><label for="hf-nombres" class=" form-control-label">Nombres:</label></div>
                                    <div class="col-12 col-md-5"><input type="text" id="hf-nombres" name="nombres" placeholder="Ingrese el nombre" required="required" class="form-control" value="<?php echo $data['nombres']; ?>"></div>
                                    </div>

                                    
                                    <div class="row form-group">
                                    <div class="col col-md-4"><label for="hf-apellidos" class=" form-control-label">Apellidos:</label></div>
                                    <div class="col-12 col-md-5"><input type="text" id="hf-apellidos" name="apellidos" placeholder="Ingrese el apellido" required="required" class="form-control" value="<?php echo $data['apellidos']; ?>"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-4"><label for="hf-dir" class=" form-control-label">Dirección:</label></div>
                                    <div class="col-12 col-md-5"><input type="textarea" id="hf-dir" name="direccion" placeholder="Ingrese la dirección" required="required" class="form-control" value="<?php echo $data['direccion']; ?>"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-4"><label for="hf-tlf" class=" form-control-label">Teléfono:</label></div>
                                    <div class="col-12 col-md-5"><input type="number" id="hf-tlf" name="telefono" placeholder="Ingrese el número de teléfono" required="required" class="form-control" value="<?php echo $data['telefono']; ?>"></div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-5"><input type="number" id="hf-salario" name="salario" placeholder="Ingrese el salario" required="required" class="form-control" value="<?php echo $data['salario']; ?>"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-4"><label for="hf-ncuenta" class=" form-control-label">Número de Cuenta:</label></div>
                                    <div class="col-12 col-md-5"><input type="text" id="hf-ncuenta" name="ncuenta" placeholder="Ingrese el número de cuenta" required="required" class="form-control" value="<?php echo $data['ncuenta']; ?>"></div>
                                    </div>
                                </div>
