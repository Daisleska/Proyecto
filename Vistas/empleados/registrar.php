                      ...
                      <div class="card-header">
                           <strong>Registro de Empleado</strong> 
                                   ...
                                   <div class="card-body card-block">
                                    ...
                                    <div class="col-12 col-md-6"><input type="number" id="hf-ci" name="ci_e" placeholder="Ingrese el número de cedula" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-nombres" class=" form-control-label">Nombres:</label></div>
                                    <div class="col-12 col-md-6"><input type="text" id="hf-nombres" name="nombres_e" placeholder="Ingrese el nombre" class="form-control"></div>
                                    </div>

                                    
                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-apellidos" class=" form-control-label">Apellidos:</label></div>
                                    <div class="col-12 col-md-6"><input type="text" id="hf-apellidos" name="apellidos_e" placeholder="Ingrese el apellido" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-dir" class=" form-control-label">Dirección:</label></div>
                                    <div class="col-12 col-md-6"><input type="textarea" id="hf-dir" name="direccion_e" placeholder="Ingrese la dirección" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-tlf" class=" form-control-label">Teléfono:</label></div>
                                    <div class="col-12 col-md-6"><input type="number" id="hf-tlf" name="telefono_e" placeholder="Ingrese el número de teléfono" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-fechai" class=" form-control-label">Fecha de Ingreso:</label></div>
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fechai" name="fecha_ingreso_e" placeholder="Ingrese la fecha de ingreso" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-condicion" class=" form-control-label">Condición</label></div>
                                    <div class="col-12 col-md-6">
                                    <select id="hf-condicion" name="condicion_e" class="form-control">
                                    ...
                                    <div class="col-12 col-md-6"><input type="date" id="hf-fechav" name="fecha_venc_e" placeholder="Ingrese la fecha de vencimiento" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-salario" class=" form-control-label">Salario:</label></div>
                                    <div class="col-12 col-md-6"><input type="number" id="hf-salario" name="salario_e" placeholder="Ingrese el salario" class="form-control"></div>
                                    </div>


                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-ncuenta" class=" form-control-label">Número de Cuenta:</label></div>
                                    <div class="col-12 col-md-6"><input type="text" id="hf-ncuenta" name="ncuenta_e" placeholder="Ingrese el número de cuenta" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-cargo" class=" form-control-label">Cargo:</label></div>
                                    <div class="col-12 col-md-6"><input type="text" id="hf-cargo" name="cargo_e" placeholder="Ingrese el cargo" class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                    <div class="col col-md-3"><label for="hf-diaslab" class=" form-control-label">Días Laborables:</label></div>
                                    <div class="col-12 col-md-6"><input type="checkbox" id="hf-diaslab" name="dia" value="Lunes" class="form-control">Lunes</div>
                                    <div class="col-12 col-md-6"><input type="checkbox" id="hf-diaslab" name="dia" value="Martes" class="form-control">Martes</div> 
                                    <div class="col-12 col-md-6"><input type="checkbox" id="hf-diaslab" name="dia" value="Miércoles" class="form-control">Miércoles</div>
                                    <div class="col-12 col-md-6"><input type="checkbox" id="hf-diaslab" name="dia" value="Jueves" class="form-control">Jueves</div>
                                    <div class="col-12 col-md-6"><input type="checkbox" id="hf-diaslab" name="dia" value="Viernes" class="form-control">Viernes</div>
                                    <div class="col-12 col-md-6"><input type="checkbox" id="hf-diaslab" name="dia" value="Sábado" class="form-control">Sábado</div>
                                    <div class="col-12 col-md-6"><input type="checkbox" id="hf-diaslab" name="dia" value="Domingo" class="form-control">Domingo</div>
                                    </div>
