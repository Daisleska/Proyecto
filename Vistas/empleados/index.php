...
<script type="text/javascript">
        function eliminar(ci_e) {
            if (confirm("Seguro que desea eliminar el registro?")) {
                    window.location="../../Controladores/ControladorEmpleados.php?operacion=eliminar&ci_e="+ci_e;
            }
        }
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <td><a href="../../Controladores/ControladorEmpleados.php?operacion=modificar&ci_e=<?=$data[$i][0]?>">Modificar</a>
