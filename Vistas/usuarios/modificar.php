                      ...
                      <div class="card-header">
                           <strong>Modificar Usuarios</strong> 
                                   ...
                                   <div class="card-body card-block">
                                    <form action="../../controladores/controladorusuarios.php" method="post" class="form-horizontal">
                                    <div class="form-group" >
                <select name="tipo_usuario" title="Seleccione el Usuario" class="form-control">
                <?php if ($data[3]=="Admin") {
                ?>
                <option value="Admin" <?php if($data[3]=="Admin"){ ?> selected="selected" <?php } ?> >Admin</option>
                <?php 
                }
                ?>
                <option value="Usuario 1" <?php if($data[3]=="Usuario 1"){ ?> selected="selected" <?php } ?> >Usuario 1</option>
                <option value="Usuario 2" <?php if($data[3]=="Usuario 2"){ ?> selected="selected" <?php } ?> >Usuario 2</option>
                </select>
                </div>
                        ...
                        <div class="form-group">
                                    ...
                                    <input name="pregunta" required="required" minlength="2" maxlength="90" type="text" class="form-control" placeholder="color favorito?" value="<?=$data[4]?>">
                        </div>

                        <div class="form-group">
                                    <label>Respuesta</label>
                                    <input name="respuesta" required="required" minlength="2" maxlength="90" type="text" class="form-control" placeholder="Azul"value="<?=$data[5]?>">
                        </div>
