        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p>REPORTES DE PAGOS DE NOMINA</p>
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Reporte de Nomina</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th>Cargo:</th>
                                            <th>9021 Opera de Producción II</th>
                                            <th>Fecha Ingreso:</th>
                                            <th>10/01/2011</th>
                                            <th>Retiro:</th>
                                            <th></th>
