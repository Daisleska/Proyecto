                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="listados_asig.php">Asignaciones</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Listado de Deducciones</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Seguro Social</th>
                                            <th>Regimen Prestacional de Empleo</th>
                                            <th>F.A.O.V</th>
                                            <th>Retención Caja de Ahorro</th>
                                            <th>Prestamo Personal</th>
                                            <th>Memoriales La Victoria C.A</th>
                                            <th>Descuento Clausula Bicicletas</th>
