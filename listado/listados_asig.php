                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="listados_deducc.php">Deducciones</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Listado de Asignaciones</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Sabado Promedio</th>
                                            <th>Descanso Semanal</th>
                                            <th>Feriado</th>
                                            <th>Refrigerios</th>
                                            <th>Prima de Antiguedad</th>
                                            <th>Prima Prof. TSU</th>
