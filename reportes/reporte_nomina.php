...
$pdf->AddPage();
    ...
    $sql="SELECT empleado.id, empleado.nombres, empleado.apellidos,empleado.cedula, nomina.total_asig, nomina.total_deducc, nomina.monto, nomina.id_prenomina FROM empleado, nomina WHERE nomina.id_prenomina=".$id_nomina." AND nomina.id_empleado=empleado.id";
