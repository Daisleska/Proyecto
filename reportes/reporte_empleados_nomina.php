...
class PDF extends FPDF {
  function Header() {
    ...
    $this->SetX(25); 
    $this->SetY(55);
    $this->Cell(40,7,utf8_decode('Empleado'),1,0,'C');
    $this->Cell(25,7,utf8_decode('Sueldo'),1,0,'C');
    $this->Cell(40,7,utf8_decode ('Total asig'),1,0,'C');
    $this->Cell(40,7,utf8_decode ('Total deducc'),1,0,'C');
    $this->Cell(40,7,utf8_decode ('Total pagar'),1,0,'C');
...
$pdf->AddPage();
    ...
    $sql= "SELECT nomina.*, pre_nomina.id, pre_nomina.quincena, pre_nomina.mes,pre_nomina.anio, empleado.nombres, empleado.cedula FROM pre_nomina, nomina, empleado WHERE nomina.id_empleado=empleado.id AND id_prenomina=".$id_pre_nomina;
    ...
    while ($fila=mysqli_fetch_array($consulta)) {
     ...
     /* $fecha=date("d/m/Y", strtotime($fila["fecha_entrega"]));*/
      ...
      $pdf->Cell(25,7,utf8_decode($fila['sueldo'].' '),1,0,'C');
